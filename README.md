...
An internal knowledge agent built with [Claude Managed Agents (CMA)](https://platform.claude.com/docs/en/managed-agents/overview). Connect your GitHub, Notion, and Slack via MCP and ask questions across all of them. Read more in the [Vercel Workflow CMA guide](https://vercel.com/kb/guide/claude-managed-agent-vercel). You can also integrate Vercel Sandbox by reading the associated [guide](https://vercel.com/kb/guide/run-claude-managed-agent-tools-with-vercel-sandbox).
